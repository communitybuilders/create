...
export const TsWcViteLitElementMixin = subclass =>
...
export const TsWcViteLitElementPackageMixin = subclass =>
  class extends CommonRepoMixin(TsWcViteLitElementMixin(subclass)) {
    async execute() {
      await super.execute();
